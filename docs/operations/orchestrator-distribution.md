...
The current fork release is **`0.0.34-orchestrator.1`**. Its base release is upstream T3 Code
...
vp run dist:desktop:dmg:arm64 --build-version 0.0.34-orchestrator.1
vp run dist:desktop:dmg:x64 --build-version 0.0.34-orchestrator.1
vp run dist:desktop:linux --build-version 0.0.34-orchestrator.1
vp run dist:desktop:win:x64 --build-version 0.0.34-orchestrator.1
vp run dist:desktop:win:arm64 --build-version 0.0.34-orchestrator.1
```
