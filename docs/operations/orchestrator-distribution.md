...
vp run dist:desktop:dmg:arm64 --build-version 0.0.33-orchestrator.5
vp run dist:desktop:dmg:x64 --build-version 0.0.33-orchestrator.5
vp run dist:desktop:win:x64 --build-version 0.0.33-orchestrator.5
vp run dist:desktop:win:arm64 --build-version 0.0.33-orchestrator.5
```
