...
vp run dist:desktop:dmg:arm64 --build-version 0.0.29-orchestrator.1
vp run dist:desktop:dmg:x64 --build-version 0.0.29-orchestrator.1
vp run dist:desktop:win:x64 --build-version 0.0.29-orchestrator.1
vp run dist:desktop:win:arm64 --build-version 0.0.29-orchestrator.1
```
