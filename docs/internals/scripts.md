...
- The Orchestrator DMG build uses `assets/orchestrator/orchestrator-macos-1024.png` as its app icon
  source, regardless of release channel.
...
- Desktop production windows load the bundled UI from the `t3-code-orchestrator://app/` root URL (not a
