...
describe("DesktopAppIdentity", () => {
  it.effect("uses the isolated custom-distribution userData path", () =>
    withIdentity(
      Effect.gen(function* () {
  ...
  it.effect("configures app identity from the environment commit override", () => {
    ...
    return withIdentity(
      Effect.gen(function* () {
        ...
        assert.deepEqual(calls.setName, ["T3 Code Orchestrator"]);
        assert.equal(calls.setAboutPanelOptions[0]?.applicationName, "T3 Code Orchestrator");
