...
export const ThreadListV2Row = memo(function ThreadListV2Row(props: {
  ...
  const iconSubtleColor = theme["--color-foreground-muted"];
  const pinTintColor = iconSubtleColor;
  const sidebarPane = props.pane === "sidebar";
  ...
  const taskHierarchyMenuItems = useMemo<MenuAction[]>(
    () =>
      props.hasTaskParent
        ? [
        ...
        : [],
    [props.hasTaskParent, props.visuallyUnnested],
  );
  const menuActions = useMemo(() => {
    const lifecycle = snoozedRow
      ...
      : !props.settlementSupported
        ...
        : canUnsettle
          ...
          : swipeActions.secondary === "snooze"
            ...
            : cardMenuActions;
    return taskHierarchyMenuItems.length === 0
      ? lifecycle
      : [...lifecycle.slice(0, -1), ...taskHierarchyMenuItems, ...lifecycle.slice(-1)];
  }, [
    canUnsettle,
    cardMenuActions,
    props.settlementSupported,
