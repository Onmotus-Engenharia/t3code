...
export interface CommandPaletteOpenIntent {
  readonly kind: "add-project" | "new-thread-in" | "start-split-view";
}
...
export type CommandPaletteUiAction =
  ...
  | { readonly _tag: "OpenStartSplitView" }
...
export function reduceCommandPaletteUiState(
  ...
  switch (action._tag) {
    ...
    case "OpenStartSplitView":
      return { open: true, mode: "command", openIntent: { kind: "start-split-view" } };
