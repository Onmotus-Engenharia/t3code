...
export const setThreadTaskOrchestration: (input: SetThreadTaskOrchestrationInput) => CommandEffect =
  Effect.fn("EnvironmentCommands.setThreadTaskOrchestration")(function* (input) {
    return yield* dispatch({
      ...input,
